            ...
            <div className={classes['main']}>
                ...
                <div className={classes['Footer']}>
                    <Grid container spacing={2}>
                                ...
                                <div className={classes['heading']}><Typography variant='h5'>Company</Typography></div>
                                {
                                    CompanyData.map((item) => (
                                        <div className={classes['footer-content']}>
                                            <div><Link className={classes.link} to={item.url}>{item.name}</Link></div>
                                        </div>
                                    ))
                                }
                            </div>
                        ...
                        <Grid item xs={12} sm={6} md={3} lg={3}>
                            <div className={classes['sections']}>
                                <div className={classes['heading']}><Typography variant='h5'>For Admin</Typography></div>
                                <div className={classes['footer-content']}>
                                    <div><Link className={classes.link} to={"/admin/dashboard"}>Admin Panel</Link></div>
                                </div>
                            </div>
                        </Grid>
