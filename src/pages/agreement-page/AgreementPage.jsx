      ...
      <div className={styles.container}>
        <div className={styles.content}>
          <h1 className={styles.title}>
            ABHICARES SERVICE PARTNER DIGITAL CONSENT & E-AGREEMENT
          </h1>

          <p className={styles.subtitle}>
            (To be accepted via Mobile App / Website)
          </p>
          ...
          <ul>
            <li>
              Confirm that you have read, understood, and accepted all terms
            </li>
            <li>
              Enter into a legally binding agreement with AbhiCares (Azadkart
              Private Limited)
            </li>
            <li>
              Provide digital consent under the Information Technology Act, 2000
            </li>
          </ul>
          ...
          <p className={styles.text}>Registered Office: Darbhanga, Bihar</p>
          <p className={styles.text}>AND</p>
          <p className={styles.text}>You (Service Partner)</p>
          <p className={styles.text}>(Name, Mobile, ID as submitted in app)</p>

          <p className={styles.sectionHeading}>
            2. Digital Acceptance (E-Consent Clause)
          </p>
          ...
          <p className={styles.subHeading}>
            c. You agree that this digital agreement is legally enforceable like
            a physical contract
          </p>
          ...
          <p className={styles.text}>
            b. AbhiCares only provides platform access & customer leads
          </p>
          <p className={styles.text}>
          ...
          <ul>
            <li>Reach customers on time</li>
            <li>Maintain professional behavior & hygiene</li>
            <li>Follow customer instructions carefully</li>
            <li>Respect privacy, safety, and property</li>
          </ul>
          ...
          <p className={styles.text}>
            a. All payments must be done only through AbhiCares App
          </p>
          <p className={styles.text}>
          ...
          <ul>
            <li>Not to share your phone number</li>
            <li>Not to take personal/offline work from customers</li>
          ...
          <ul>
            <li>Not store or misuse customer data</li>
            <li>Not share phone numbers, addresses, or personal info</li>
          </ul>
          ...
          <ul>
            ...
            <li>Company systems</li>
          </ul>

          <p className={styles.text}>
            This continues even after leaving AbhiCares
          </p>
          ...
          <p className={styles.text}>
            You give permission to AbhiCares to use:
          </p>

          <ul>
            <li>Your name</li>
            <li>Your photo</li>
            <li>Your work images/videos</li>
          </ul>
          ...
          <p className={styles.text}>You understand:</p>

          <ul>
            <li>Work is not guaranteed</li>
            <li>Work depends on:</li>
            <li>Ratings</li>
            <li>Reviews</li>
            <li>Performance</li>
            <li>Availability</li>
          ...
          <ul>
            <li>Without notice (in serious violation cases)</li>
          ...
          <p className={styles.text}>b. AbhiCares is not liable for:</p>

          <ul>
            <li>Personal mistakes</li>
            <li>Damage caused by you</li>
            <li>Customer disputes due to your behavior</li>
          </ul>
          ...
          <ul>
            <li>Not to copy AbhiCares model</li>
            <li>Not to misuse company knowledge</li>
            <li>Not to build competing services using internal learnings</li>
          </ul>
          ...
          <ul>
            <li>Pension Policy</li>
            <li>Financial Support Policy</li>
          ...
          <p className={styles.text}>
            “AbhiCares is built to create opportunities for skilled workers and
            bring trust to customers. By joining, you agree to work with
            honesty, discipline, and commitment to this mission.”
          </p>
          ...
          <ul>
            <li>☑ I confirm all details provided are true</li>
