            ...
            <section className={classes.privacy_policy}>
                ...
                <div className={classes.wrapper}>
                    <div className={classes.container}>
                        ...
                        <p className={classes.date}>Last updated: April 18, 2024</p>
                        <p>
                        ...
                        <ul>
                            ...
                            <li>
                                <p>
                                    <strong>Application</strong> refers to Abhicares, the software program
                            ...
                            <li>
                                <p>
                                    ...
                                    refers to AzadKart Private limited, C/O-SHYAM BIHARI SAH-KHASRA NO.1288
                                    1289, VILL/TOLA/PANCH-TARALAHI BAHADURPUR Darbhanga, Darbhanga ,
                                    Bihar-846003.
                                </p>
                            </li>
                            <li>
