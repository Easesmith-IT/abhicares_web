...
const Category = () => {
  ...
  const uploadImages = async (type) => {
    ...
    setData({ img: banners[t].file, type: type, page: "category-banners", section: "app-categorypage" })
  ...
  const uploadHeroImages = async (type) => {
    ...
    setData({ img: filtered.file, type: type, page: "category-banners", section: "app-categorypage" })
